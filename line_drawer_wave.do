...
add wave -noupdate /line_drawer_testbench/dut/ps
add wave -noupdate /line_drawer_testbench/dut/ns
...
add wave -noupdate /line_drawer_testbench/dut/x_out
add wave -noupdate /line_drawer_testbench/dut/y_out
add wave -noupdate /line_drawer_testbench/dut/x1_latch
add wave -noupdate /line_drawer_testbench/dut/y1_latch
add wave -noupdate /line_drawer_testbench/dut/x_step
add wave -noupdate /line_drawer_testbench/dut/y_step
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {1264 ps} 0}
